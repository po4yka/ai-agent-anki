...
Actions:
• /anki-search "tag:python" --limit 20  (show more)
• /anki-review Programming              (review these)
```
...
```
/anki-search "prop:lapses>=3"
```

### Find cards added recently

```
/anki-search "added:7 deck:MyDeck"
```

### Find untagged cards

```
/anki-search "-tag:* deck:Default"
```

### Find cards by content

```
/anki-search "front:*recursion*"
```

### Find suspended cards

```
/anki-search "is:suspended deck:Programming"
```
...
```
/anki-search "is:due"
/anki-search "deck:Spanish tag:verbs" --show-answer
/anki-search "added:30" --limit 50
/anki-search "front:capital" --deck Geography
/anki-search "prop:ease<2" --show-answer
```
